  ...
  handleData(msg) { // 处理数据
    ...
    if (data.ping) {
      ...
      if (data.data) {
        ...
        // loadMinlineData(historyData)
        // localStorage.setItem('minline'+SYMBOL,JSON.stringify(historyData))
        // console.log(historyData)
        loading(1)
        if(chart_type==0){
            ...
            // loadMinlineData(historyData1)
            // localStorage.setItem('minline'+SYMBOL,JSON.stringify(historyData1))
