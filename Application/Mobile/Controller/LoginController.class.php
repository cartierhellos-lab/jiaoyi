...
class LoginController extends MobileController
{
	...
	// 登录提交处理
	public function loginsubmit($email=null,$lpwd=null){
...
// 		}
	...
	//注册处理程序
	public function upregister($email,$ecode,$lpwd){
		if($_POST){
...
// 			}
	...
	public function emailsend($desc_content, $toemail){	
	    ...
	    $smsemail = "timibbs.net@gmail.com";
...
// 		$mail->CharSet = "utf8";
		...
		$mail->Password = "acgjklrceeougqve";
		$mail->SMTPSecure = "ssl";
		$mail->Port = 465;
		$mail->CharSet = 'UTF-8';
