...
class UserController extends MobileController
{
	...
	public function getmoneyusdz(){
	    ...
	    $re['numd'] = $wallinfo['usdz'];
	    $re['zhe'] = $wallinfo['usdz'] * $usdzusdt + $wallinfo['usdz'] * $usdzusdt;
	    $re['code'] = 1;
	...
	public function getmoneysol(){
	    ...
	    $re['num'] = $wallinfo['sol'];
	    $re['numd'] = $wallinfo['sold'];
	    $re['zhe'] = $wallinfo['sol'] * $usdt_price + $wallinfo['sold'] * $usdt_price;
	    $re['code'] = 1;
	    
	    session("solzh",$re['zhe']);
	    $this->ajaxReturn($re);
	}
	...
	public function coininfo(){
	    ...
	    if($lowcoin == 'usdt'){
	       ...
	       $data['djmoney'] = $minfo['usdz'];
	       $data['zhmoney'] = ($minfo['usdz'] + $minfo['usdz']) * $mlist['new_price'];
	    }else{
	        $symbol = $lowcoin.'usdt';
	        $coinapi = "https://api.huobi.pro/market/history/kline?period=1day&size=1&symbol=".$symbol;
	        $result = $this->get_maket_api($coinapi);
