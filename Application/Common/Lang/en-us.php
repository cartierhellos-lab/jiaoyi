...
return [
    "查看" => "Check",
    "转数快" => "fast speed",
    "使用您优选的付款方式买卖" => "Buy and sell using your preferred payment method",
    "上安全轻松地买卖TetherUS。立即使用您的首选的付款方式找到最佳报价并买卖" => "Buy and sell tetherus safely and easily on. Use your preferred payment method to find the best price and buy and sell now",
    "快捷区" => "Shortcut area",
    "购买" => "Buy",
    "出售" => "Sale",
    ...
    "价格" => "Price",
    "限额" => "Limit",
    "如何购买数字货币" => "How to buy digital currency",
    "我要支付" => "I want to pay",
    "我将收到" => "I will receive",
    "限时" => "Time limit",
    "小时" => "Hours",
    "支付方式" => "Payment method",
    "现金当面交易" => "Cash face-to-face transaction",
    "交易条款" => "Transaction terms",
    "不满足广告方要求" => "Not satisfied",
    ...
    "持仓单" => "Position Receipt",
    "资金账户" => "funds",
    "保证金" => "Margin",
    "确定平仓" => "Sure",
    "现在结算预计亏损"=>"Settle estimated losses now",
    "确定要结算吗？"=>"Are you sure you want to checkout?",
    "现在结算预计盈利"=>"Settlement estimated profit now",
    "盈亏状态" => "status",
    "盈利" => "profit",
    "亏损" => "loss",
    "止损单价" => "stop price",
    ...
    "上涨" => "rise",
    "下跌" => "fall",
    "快速合约订单" => "Express Contract Orders",
    "永续合约订单" => "Perpetual Contract Orders",
    "永续合约已平仓订单" => "Perpetual Swap Closed Order",
    "永续合约委托订单" => "Perpetual Swap Order",
    "杠杆" => "lever",
    "手数" => "lot size",
    "永续合约持仓订单" => "Perpetual Contract Position Order",
    "永续合约委托" => "Perpetual contract delegation",
    "永续合约平仓" => "perpetual contract close",
    "做多" => "buy up",
    "做空" => "buy down",
    "一键平仓" => "Settlement",
    "永续合约" => "perpetual contract",
    "合约交易" => "contract",
    "合约市场" => "Contract market",
    ...
    "暂停交易" => "suspended trading",
    "划转" => "transfer",
    "划转类型" => "transfer type",
    "可划转" => "transferable",
    "划转数量" => "Transfer amount",
    "合约交易开仓手续费" => "Contract transaction opening fee",
    "合约交易止盈平仓盈利收益" => "Profit and income of contract trading take profit and closing position",
    "合约交易止损平仓收益" => "Contract Trading Stop Loss Closing Income",
    "合约交易止损平仓收益" => "Contract Trading Stop Loss Closing Income",
    "合约交易爆仓,资产清零" => "The contract transaction is liquidated, and the assets are cleared",
    "开仓/平仓价" => "open/close price",
    "永续合约持仓" => "Perpetual Contract Positions",
    "有合约定单未结算，不能划转保证金" => "There are contract orders that have not been settled, and the margin cannot be transferred",
    "开仓单价" => "Opening unit price",
    "爆仓" => "liquidation",
    "全部持仓" => "positions",
    "操作提示" => "Operation Tips",
    "该合约不能撤消" => "The contract cannot be undone",
    ...
    "输入划转数量" => "Enter the transfer amount",
    "可用保证金不足，请先从资金账户划转" => "Insufficient available margin, please transfer from the capital account first",
    "占用保证金" => "Occupy margin",
    "资金划转" => "Fund transfer",
    "保证金转资金账户" => "Margin transfer funds",
    "资金账户转保证金" => "Fund transfer margin",
    "划转成功" => "successful transfer",
    "划转失败" => "transfer failed",

    
    '还有未完成订单'=>'There are still outstanding orders',
    "税金类型" => "Tax type",
    "缴纳税金" => "Pay taxes",
    "应缴纳税金" => "Tax payable",
    "缴纳数量" => "Payment quantity",
    "缴税" => "pay taxes",
    
    "缴纳税金" => "Pay taxes",
    "税金审核" => "Tax audit",
    "缴纳税金审核成功" => "Tax payment approved successfully",
    "缴纳税金审核被驳回，请联系客服" => "Tax payment review rejected, please contact customer service",
    "税金审核驳回成功" => "Tax approval rejected successfully",
    "税金审核驳回失败" => "Failed to reject tax approval",
    "请先缴纳税金" => "Please pay the tax first",
    
    
    "持仓" => "hold",
    "禁止提币" => "Withdrawal prohibited",
    "建仓" => "buy",
    "正在结算中" => "Billing",
    "继续下单" => "continue",
	...
	"合约出售" => "Contract sale",
	"快速合约交易" => "Express contract transaction",
	"快速合约已平仓，请及时加仓" => "The express contract has been closed. Please increase your position in time",
    ...
    "快速合约委托" => "Express contract entrustment",
    "账户登录" => "Account login",
	...
	"现货" => "Spot",
	"合约" => "Contract",
	"通过提供更多个人资料信息来获取更高限额和二级功能。" => "Get higher limit and secondary function by providing more personal information.",
	"验证身份" => "Authentication",
	"总额" => "Total",
	"币币兑换" => "Currency exchange",
	"NFT" => "Mystery Box",
	...
	"搜索交易对" 		=> "Search transaction pairs",
	"涨跌" 		=> "Up and down",
	"全部行情" 		=> "All quotations",
	"隐私条款" 		=> "Privacy clause",
